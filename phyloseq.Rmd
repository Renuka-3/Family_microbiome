...
```{r phyloseq, echo=FALSE, message=FALSE, warning=FALSE}
library(ggplot2)
library(phyloseq)
library(dada2)
library(readxl)
...
otu_mat    <- as.data.frame(read_excel("../../inputdata/processed/tables/OTU_table.xlsx"))
tax_mat    <- as.data.frame(read_excel("../../inputdata/processed/tables/taxa_table.xlsx"))
samples_df <- as.data.frame(read_excel("../../inputdata/processed/tables/Metadata.xlsx"))
